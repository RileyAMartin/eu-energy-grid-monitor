...
@pytest.mark.parametrize(
    ...
    [
        (
            "generation-test-curvetype-A01.xml",
            5,
...
def test_parse_generation_document(input_filename, expected_record_count, expected_start_time, expected_end_time, expected_psr_type_codes, expected_quantities):
