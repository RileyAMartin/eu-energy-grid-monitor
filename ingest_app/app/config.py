...
_PRICING_EIC_CODES_FILE_PATH = os.path.join(_config_dir_path, "eic_codes_pricing.txt")
...
class Settings(BaseSettings):
    ...
    EIC_CODES_PRICING: list[str] = _load_eic_codes_from_file(_PRICING_EIC_CODES_FILE_PATH)
